...
return [
    ...
    'not_student'                        => ':attribute không phải là học sinh.',
    'not_program'                        => 'students do not belong program id: ',
    'graduated_student'                  => 'sinh viên chưa đủ điều kiện tốt nghiệp',
    'student_already_graduated'          => 'sinh viên đã tốt nghiệp rồi',
    "student_family"                     => "số lượng tối đa là 2 tài khoản gia đình",
    "student_progress"                   => "học sinh chưa được giao cho nhân viên nào",
    'progress_inputter'                  => 'người dùng không phải là inputter',
    'progress_reviewer'                  => 'người dùng không phải là reviewer',
];
